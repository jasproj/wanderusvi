// s51 render verification (copy of s50-wusvi-refresh/verify-render.mjs, population path only): node vm over BOTH dynamic render paths (app.js createTourCard, activity-tours.js strip)
...
const POP = new Set(JSON.parse(fs.readFileSync('scripts-staging/evidence/s51-wusvi-restamp/population.json', 'utf8')).pks);
